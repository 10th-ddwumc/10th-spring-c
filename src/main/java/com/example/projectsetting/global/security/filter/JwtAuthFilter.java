package com.example.projectsetting.global.security.filter;
...
import com.example.projectsetting.global.apiPayload.code.GeneralErrorCode;
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (jwtUtil.isValid(token)) {
                // 토큰에서 유저 정보 조회: UID와 소셜 로그인 타입 가져오기
